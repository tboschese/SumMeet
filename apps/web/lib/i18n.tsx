...
const en = {
  ...
  "ask.link": "Ask",
  "ask.title": "Ask your meetings",
  "ask.tagline": "Questions answered from your own decision records.",
  "ask.placeholder": "e.g. list today's main tasks",
  "ask.ask": "Ask",
  "ask.thinking": "Thinking…",
  "ask.over": "From {count} meetings",
  "ask.suggest.tasks": "List today's main tasks",
  "ask.suggest.decisions": "What decisions are still open?",
  "ask.suggest.week": "Summarise this week's meetings",
  "ask.suggest.followups": "What did I commit to?",
  "home.trash": "Trash",
  "home.folder.all": "All",
  "home.folder.unfiled": "Unfiled",
  "home.folder.new": "+ New folder",
  "home.folder.newTitle": "New folder",
  "home.folder.create": "Create",
  "home.folder.rename": "Rename",
  "home.folder.renameTitle": "Rename folder",
  "home.folder.delete": "Delete folder",
  "home.folder.deleteWarning": "Delete the folder \u201c{name}\u201d? Its meetings are kept, just unfiled.",
  "home.folder.move": "Move to folder",
  "home.folder.none": "No folder",
  "home.folderFailed": "Could not update the folder.",
  "home.backToMeetings": "Back to meetings",
  "home.trashEmpty": "The trash is empty.",
  "home.noMatches": "No meetings match those filters.",
  "home.searchPlaceholder": "Search title, transcript, decisions…",
  "home.search.in.transcript": "in transcript",
  "home.search.in.summary": "in summary",
  "calendar.today": "Today",
  "calendar.prev": "Previous month",
  "calendar.next": "Next month",
  "calendar.hasNotes": "You took notes this day",
  "calendar.notesTag": "your notes",
  "agenda.yesterday": "Yesterday",
  "agenda.showMore": "Show earlier days",
  "agenda.allDays": "All days",
  "home.filter.allStatuses": "All statuses",
  "home.trashed": "\u201c{title}\u201d moved to the trash.",
  "home.undo": "Undo",
  "home.restore": "Restore",
  "home.restoreFailed": "Could not restore the meeting.",
  "home.deleteForever": "Delete forever",
  "home.purgeWarning": "\u201c{title}\u201d will be gone for good. The recording is already discarded, so the summary and transcript cannot be rebuilt.",
  "home.emptyTrash": "Empty the trash",
  "home.emptyTrashWarning": "Every meeting in the trash will be gone for good. This cannot be undone.",
  "home.deletedOn": "Deleted {date}",
  "home.pageOf": "Page {page} of {pages} \u00b7 {total} meetings",
  "home.prev": "Previous",
  "home.next": "Next",
  // ── shared ──────────────────────────────────────────────────────────────
  ...
  "detail.notes": "Notes",
  "detail.notes.enhance": "Enhance from transcript",
  "detail.notes.reenhance": "Re-enhance",
  "detail.notes.enhancing": "Enhancing…",
  "detail.notes.enhanceFailed": "Could not enhance the notes.",
  "detail.version.label": "Version:",
  "detail.version.n": "v{n}",
  "detail.version.latest": "latest",
  ...
  "work.link": "My work",
  "work.title": "My work",
  "work.subtitle": "Everything you agreed to and decided, pulled from every meeting.",
  "work.tab.commitments": "Commitments",
  "work.tab.decisions": "Decisions",
  "work.owner.mine": "Mine",
  "work.owner.all": "Everyone",
  "work.count": "{n} open",
  "work.count.decisions": "{n} decisions",
  "work.loading": "Loading…",
  "work.loadFailed": "Couldn't load — is the app running?",
  "work.empty.commitments": "No open commitments — you're all caught up.",
  "work.empty.decisions": "No decisions recorded yet.",
  "work.bucket.overdue": "Overdue",
  "work.bucket.today": "Today",
  "work.bucket.week": "This week",
  "work.bucket.later": "Later",
  "work.bucket.someday": "No date",
  "work.due": "due {date}",
...
const ptBR: Record<TKey, string> = {
  ...
  "ask.link": "Perguntar",
  "ask.title": "Pergunte às suas reuniões",
  "ask.tagline": "Respostas a partir dos seus próprios registros de decisão.",
  "ask.placeholder": "ex.: liste as principais tarefas do dia",
  "ask.ask": "Perguntar",
  "ask.thinking": "Pensando…",
  "ask.over": "De {count} reuniões",
  "ask.suggest.tasks": "Liste as principais tarefas do dia",
  "ask.suggest.decisions": "Quais decisões ainda estão em aberto?",
  "ask.suggest.week": "Resuma as reuniões desta semana",
  "ask.suggest.followups": "Com o que eu me comprometi?",
  "home.trash": "Lixeira",
  "home.folder.all": "Todas",
  "home.folder.unfiled": "Sem pasta",
  "home.folder.new": "+ Nova pasta",
  "home.folder.newTitle": "Nova pasta",
  "home.folder.create": "Criar",
  "home.folder.rename": "Renomear",
  "home.folder.renameTitle": "Renomear pasta",
  "home.folder.delete": "Excluir pasta",
  "home.folder.deleteWarning": "Excluir a pasta \u201c{name}\u201d? As reuniões são mantidas, apenas sem pasta.",
  "home.folder.move": "Mover para pasta",
  "home.folder.none": "Sem pasta",
  "home.folderFailed": "Não foi possível atualizar a pasta.",
  "home.backToMeetings": "Voltar às reuniões",
  "home.trashEmpty": "A lixeira está vazia.",
  "home.noMatches": "Nenhuma reunião corresponde a esses filtros.",
  "home.searchPlaceholder": "Buscar em título, transcrição, decisões…",
  "home.search.in.transcript": "na transcrição",
  "home.search.in.summary": "no resumo",
  "calendar.today": "Hoje",
  "calendar.prev": "Mês anterior",
  "calendar.next": "Próximo mês",
  "calendar.hasNotes": "Você fez anotações neste dia",
  "calendar.notesTag": "suas anotações",
  "agenda.yesterday": "Ontem",
  "agenda.showMore": "Ver dias anteriores",
  "agenda.allDays": "Todos os dias",
  "home.filter.allStatuses": "Todos os status",
  "home.trashed": "\u201c{title}\u201d foi para a lixeira.",
  "home.undo": "Desfazer",
  "home.restore": "Restaurar",
  "home.restoreFailed": "Não foi possível restaurar a reunião.",
  "home.deleteForever": "Excluir definitivamente",
  "home.purgeWarning": "\u201c{title}\u201d será perdida para sempre. A gravação já foi descartada, então o resumo e a transcrição não podem ser refeitos.",
  "home.emptyTrash": "Esvaziar a lixeira",
  "home.emptyTrashWarning": "Todas as reuniões da lixeira serão perdidas para sempre. Isso não pode ser desfeito.",
  "home.deletedOn": "Excluída em {date}",
  "home.pageOf": "Página {page} de {pages} \u00b7 {total} reuniões",
  "home.prev": "Anterior",
  "home.next": "Próxima",
  ...
  "detail.notes.enhance": "Enriquecer da transcrição",
  "detail.notes.reenhance": "Reenriquecer",
  "detail.notes.enhancing": "Enriquecendo…",
  "detail.notes.enhanceFailed": "Não foi possível enriquecer as notas.",
  "detail.version.label": "Versão:",
  "detail.version.n": "v{n}",
  "detail.version.latest": "mais recente",
  ...
  "work.link": "Compromissos",
  "work.title": "Meus compromissos",
  "work.subtitle": "Tudo que você se comprometeu a fazer e decidiu, reunido de todas as reuniões.",
  "work.tab.commitments": "Compromissos",
  "work.tab.decisions": "Decisões",
  "work.owner.mine": "Meus",
  "work.owner.all": "Todos",
  "work.count": "{n} em aberto",
  "work.count.decisions": "{n} decisões",
  "work.loading": "Carregando…",
  "work.loadFailed": "Não foi possível carregar — o app está rodando?",
  "work.empty.commitments": "Nenhum compromisso em aberto — você está em dia.",
  "work.empty.decisions": "Nenhuma decisão registrada ainda.",
  "work.bucket.overdue": "Atrasado",
  "work.bucket.today": "Hoje",
  "work.bucket.week": "Esta semana",
  "work.bucket.later": "Depois",
  "work.bucket.someday": "Sem prazo",
  "work.due": "prazo {date}",
  "work.priority.high": "Alta",
  "work.priority.medium": "Média",
  "work.priority.low": "Baixa",
  "work.quote": "trecho",
  "work.because": "porque",
