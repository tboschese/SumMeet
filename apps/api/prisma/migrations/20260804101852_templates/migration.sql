...
INSERT INTO "new_Meeting" ("audioKey", "channelLayout", "createdAt", "deletedAt", "durationSec", "enhancedNotes", "error", "folderId", "id", "language", "notes", "status", "title", "updatedAt", "userId") SELECT "audioKey", "channelLayout", "createdAt", "deletedAt", "durationSec", "enhancedNotes", "error", "folderId", "id", "language", "notes", "status", "title", "updatedAt", "userId" FROM "Meeting";
DROP TABLE "Meeting";
