...
INSERT INTO "new_Settings" ("autoExtract", "extractionEngine", "glossary", "groqApiKey", "id", "outputLanguage", "summarySections", "transcriptionEngine", "transcriptionLanguage", "uiLanguage", "updatedAt") SELECT "autoExtract", "extractionEngine", "glossary", "groqApiKey", "id", "outputLanguage", "summarySections", "transcriptionEngine", "transcriptionLanguage", "uiLanguage", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
